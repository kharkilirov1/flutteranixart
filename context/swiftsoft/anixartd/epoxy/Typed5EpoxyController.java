...
public abstract class Typed5EpoxyController<T, U, V, W, X> extends EpoxyController {
    ...
    public void buildModels() {
        ...
        buildModels(t, u, v, w, x);
    }

    public abstract void buildModels(T data1, U data2, V data3, W data4, X data5);
    ...
    public Typed5EpoxyController(@NotNull Handler modelBuildingHandler, @NotNull Handler diffingHandler) {
