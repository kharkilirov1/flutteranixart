...
/* compiled from: ProfileBlockListUiController.kt */
@Metadata(m31883d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\u0010\u000b\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\b\u0018\u0000 \u000f2 \u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u0002\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0001:\u0002\u000f\u0010B\u0005¢\u0006\u0002\u0010\u0007J.\u0010\b\u001a\u00020\t2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00030\u00022\u0006\u0010\u000b\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\u00052\u0006\u0010\r\u001a\u00020\u0006H\u0014J\u0006\u0010\u000e\u001a\u00020\u0005¨\u0006\u0011"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/controller/main/profile/ProfileBlockListUiController;", "Lcom/airbnb/epoxy/Typed4EpoxyController;", "", "Lcom/swiftsoft/anixartd/database/entity/Profile;", "", "", "Lcom/swiftsoft/anixartd/ui/controller/main/profile/ProfileBlockListUiController$Listener;", "()V", "buildModels", "", "blockedProfiles", "blockedProfilesCount", "isLoadable", "listener", "isEmpty", "Companion", "Listener", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1}, m31888xi = 48)
/* loaded from: classes2.dex */
public final class ProfileBlockListUiController extends Typed4EpoxyController<List<? extends Profile>, Long, Boolean, Listener> {
    private static final int ACTION_UNBLOCK = 1;

    /* compiled from: ProfileBlockListUiController.kt */
    @Metadata(m31883d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/controller/main/profile/ProfileBlockListUiController$Listener;", "Lcom/swiftsoft/anixartd/ui/model/common/SectionHeaderModel$Listener;", "Lcom/swiftsoft/anixartd/ui/model/main/profile/friends/FriendRequestModel$Listener;", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1}, m31888xi = 48)
    public interface Listener extends SectionHeaderModel.Listener, FriendRequestModel.Listener {
    }

    public ProfileBlockListUiController() {
    ...
    public void buildModels(@NotNull List<Profile> blockedProfiles, long blockedProfilesCount, boolean isLoadable, @NotNull Listener listener) {
        ...
        if (!blockedProfiles.isEmpty()) {
            ...
            sectionHeaderModel_.mo15775e0(C2507R.string.profile_block_list);
            sectionHeaderModel_.mo15778w1(String.valueOf(blockedProfilesCount));
            sectionHeaderModel_.mo15777t0(listener);
            add(sectionHeaderModel_);
            for (Profile profile : blockedProfiles) {
                ...
                friendRequestModel_.mo16139A0(profile.getBlockListAddedDate());
                friendRequestModel_.mo16141I0(C2507R.string.remove_from_block_list);
                ...
                friendRequestModel_.mo16146d(C6284a.f58033m);
            ...
            errorResourceModel_.mo15726T0(C2507R.string.error_no_blocked_profiles);
