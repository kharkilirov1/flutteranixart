...
public class UpdateAvailableModel_ extends UpdateAvailableModel implements GeneratedModel<View>, UpdateAvailableModelBuilder {
    ...
    /* renamed from: d2 */
    public int mo4499d2() {
        return C2507R.layout.item_update_available;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Objects.requireNonNull(updateAvailableModel_);
        return (this.f29460k == null) == (updateAvailableModel_.f29460k == null);
    }
    ...
    @Override // com.airbnb.epoxy.EpoxyModel
    public int hashCode() {
        return (((((((((super.hashCode() * 31) + 0) * 31) + 0) * 31) + 0) * 31) + 0) * 31) + (this.f29460k != null ? 1 : 0);
    }
    ...
    public String toString() {
        StringBuilder m24u = C0000a.m24u("UpdateAvailableModel_{listener=");
        m24u.append(this.f29460k);
        m24u.append("}");
