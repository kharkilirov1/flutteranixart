...
/* renamed from: com.swiftsoft.anixartd.ui.model.main.discover.a */
/* loaded from: classes2.dex */
public final /* synthetic */ class ViewOnClickListenerC2754a implements View.OnClickListener {

    /* renamed from: b */
    public final /* synthetic */ int f29655b;

    /* renamed from: c */
    public final /* synthetic */ Ref.BooleanRef f29656c;

    /* renamed from: d */
    public final /* synthetic */ View f29657d;

    public /* synthetic */ ViewOnClickListenerC2754a(Ref.BooleanRef booleanRef, View view, int i2) {
        this.f29655b = i2;
        this.f29656c = booleanRef;
        this.f29657d = view;
    }
    ...
    public final void onClick(View view) {
        switch (this.f29655b) {
            case 0:
                Ref.BooleanRef isExpanded = this.f29656c;
                View view2 = this.f29657d;
                ...
                if (!isExpanded.f63347b) {
                    ...
                    ((TextView) view2.findViewById(C2507R.id.tvSpoilerAction)).setText(view2.getContext().getString(C2507R.string.comment_spoiler_hide));
                    ...
                    ((TextView) view2.findViewById(C2507R.id.tvSpoilerAction)).setText(view2.getContext().getString(C2507R.string.comment_spoiler_show));
            ...
            default:
                Ref.BooleanRef isExpanded2 = this.f29656c;
                View view3 = this.f29657d;
                ...
                if (!isExpanded2.f63347b) {
                    ...
                    ((TextView) view3.findViewById(C2507R.id.tvSpoilerAction)).setText("Нажмите, чтобы скрыть");
                    ...
                    ((TextView) view3.findViewById(C2507R.id.tvSpoilerAction)).setText("Нажмите, чтобы увидеть");
