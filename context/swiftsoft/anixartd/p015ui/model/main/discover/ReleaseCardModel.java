...
@EpoxyModelClass
@Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b'\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u0003\u0004¨\u0006\u0005"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/discover/ReleaseCardModel;", "Lcom/airbnb/epoxy/EpoxyModel;", "Landroid/view/View;", "Companion", "Listener", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
...
public abstract class ReleaseCardModel extends EpoxyModel<View> {
    ...
    @EpoxyAttribute
    @Nullable
    public Integer f29638l = 0;

    /* renamed from: m */
    @EpoxyAttribute
    @Nullable
    public Integer f29639m = 0;

    /* renamed from: n */
    @EpoxyAttribute
    @Nullable
    public Double f29640n = Double.valueOf(0.0d);
    ...
    /* renamed from: s */
    @EpoxyAttribute
    public boolean f29645s;

    /* renamed from: t */
    @EpoxyAttribute
    public Listener f29646t;

    /* compiled from: ReleaseCardModel.kt */
    @Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u000b\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0006\u0010\u0004R\u0014\u0010\u0007\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0007\u0010\u0004R\u0014\u0010\b\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\b\u0010\u0004R\u0014\u0010\t\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\t\u0010\u0004R\u0014\u0010\n\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\n\u0010\u0004R\u0014\u0010\u000b\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u000b\u0010\u0004R\u0014\u0010\f\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\f\u0010\u0004¨\u0006\r"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/discover/ReleaseCardModel$Companion;", "", "", "DESCRIPTION_CHANGED", "I", "EPISODES_RELEASED_CHANGED", "EPISODES_TOTAL_CHANGED", "FAV_CHANGED", "GRADE_CHANGED", "IMAGE_CHANGED", "RATING_AVAILABLE_CHANGED", "STATUS_CHANGED", "TITLE_CHANGED", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
    public static final class Companion {
    }

    /* compiled from: ReleaseCardModel.kt */
    @Metadata(m31882bv = {}, m31883d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bf\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/discover/ReleaseCardModel$Listener;", "", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
    ...
    public void mo4496Z1(View view) {
        ...
        ViewsKt.m16379l(linearLayout, this.f29645s);
        if (d != null) {
        ...
        ViewsKt.m16375h(appCompatImageView, this.f29642p);
        ViewsKt.m16377j(view2, new Function1<View, Unit>() { // from class: com.swiftsoft.anixartd.ui.model.main.discover.ReleaseCardModel$bind$2
            {
                super(1);
            }
            ...
            public Unit invoke(View view3) {
                ...
                ReleaseCardModel.Listener listener = releaseCardModel.f29646t;
                if (listener != null) {
                    listener.mo14550g(releaseCardModel.f6925b);
                    return Unit.f63088a;
                }
        ...
        view2.setOnLongClickListener(new ViewOnLongClickListenerC2720d(this, 6));
    }
    ...
    public void mo4497a2(View view, EpoxyModel epoxyModel) {
        ...
        if (epoxyModel instanceof ReleaseCardModel) {
            ...
            if (!Intrinsics.m32174c(this.f29637k, releaseCardModel.f29637k)) {
                m12276k.add(0);
            }
            if (!Intrinsics.m32174c(this.f29638l, releaseCardModel.f29638l)) {
                m12276k.add(1);
            }
            if (!Intrinsics.m32174c(this.f29639m, releaseCardModel.f29639m)) {
                m12276k.add(2);
            }
            if (!Intrinsics.m32172a(this.f29640n, releaseCardModel.f29640n)) {
                m12276k.add(3);
            }
            if (!Intrinsics.m32174c(this.f29641o, releaseCardModel.f29641o)) {
                m12276k.add(4);
            }
            if (!Intrinsics.m32174c(this.f29642p, releaseCardModel.f29642p)) {
                m12276k.add(5);
            }
            if (this.f29643q != releaseCardModel.f29643q) {
                m12276k.add(6);
            }
            if (this.f29644r != releaseCardModel.f29644r) {
                m12276k.add(7);
            }
            if (this.f29645s != releaseCardModel.f29645s) {
                m12276k.add(8);
            }
            if (!m12276k.isEmpty()) {
    ...
    public void mo4519b2(@NotNull View view, @NotNull List<Object> list) {
        ...
        if (C2052a.m12291z(view, "view", list, "payloads", 0)) {
            ((TextView) view.findViewById(C2507R.id.title)).setText(this.f29637k);
        }
        if (list.contains(1)) {
            TextView textView = (TextView) view.findViewById(C2507R.id.episodes);
            StringBuilder sb = new StringBuilder();
            sb.append(this.f29638l);
            sb.append(" из ");
            C2052a.m12288w(sb, this.f29639m, textView);
        }
        if (list.contains(2)) {
            TextView textView2 = (TextView) view.findViewById(C2507R.id.episodes);
            StringBuilder sb2 = new StringBuilder();
            sb2.append(this.f29638l);
            sb2.append(" из ");
            C2052a.m12288w(sb2, this.f29639m, textView2);
        }
        if (list.contains(3) && (d = this.f29640n) != null) {
        ...
        if (list.contains(6)) {
            ((ImageView) view.findViewById(C2507R.id.favorite)).setVisibility(this.f29643q ? 0 : 8);
        }
        if (list.contains(7)) {
            if (this.f29644r != 0) {
