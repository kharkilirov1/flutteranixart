...
/* compiled from: ProfileReleaseCommentModel.kt */
@EpoxyModelClass
@Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b'\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u0003\u0004¨\u0006\u0005"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/profile/comments/ProfileReleaseCommentModel;", "Lcom/airbnb/epoxy/EpoxyModel;", "Landroid/view/View;", "Companion", "Listener", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
/* loaded from: classes2.dex */
public abstract class ProfileReleaseCommentModel extends EpoxyModel<View> {
    ...
    @EpoxyAttribute
    @NotNull
    public String f29883p = "";

    /* renamed from: v */
    @EpoxyAttribute
    @NotNull
    public String f29889v = "";

    /* renamed from: w */
    @EpoxyAttribute
    @Nullable
    public String f29890w = "";

    /* compiled from: ProfileReleaseCommentModel.kt */
    @Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u000e\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0006\u0010\u0004R\u0014\u0010\u0007\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0007\u0010\u0004R\u0014\u0010\b\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\b\u0010\u0004R\u0014\u0010\t\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\t\u0010\u0004R\u0014\u0010\n\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\n\u0010\u0004R\u0014\u0010\u000b\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u000b\u0010\u0004R\u0014\u0010\f\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\f\u0010\u0004R\u0014\u0010\r\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\r\u0010\u0004R\u0014\u0010\u000e\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u000e\u0010\u0004R\u0014\u0010\u000f\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u000f\u0010\u0004¨\u0006\u0010"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/profile/comments/ProfileReleaseCommentModel$Companion;", "", "", "AVATAR_CHANGED", "I", "DATE_CHANGED", "DELETED_CHANGED", "EDITED_CHANGED", "MIN_NEGATIVE_VOTES", "NICKNAME_CHANGED", "RELEASE_TITLE_CHANGED", "SPOILER_CHANGED", "SPONSOR_CHANGED", "TEXT_CHANGED", "VERIFIED_CHANGED", "VOTES_CHANGED", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
    public static final class Companion {
    }

    /* compiled from: ProfileReleaseCommentModel.kt */
    @Metadata(m31882bv = {}, m31883d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bf\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/model/main/profile/comments/ProfileReleaseCommentModel$Listener;", "", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
    public interface Listener {
        /* renamed from: N */
        void mo14864N(long j2, long j3, long j4);
    ...
    public void mo4496Z1(View view) {
        ...
        ((TextView) view2.findViewById(C2507R.id.message)).setText(this.f29883p);
        ((TextView) view2.findViewById(C2507R.id.nickname)).setText(this.f29889v);
        ((TextView) view2.findViewById(C2507R.id.title)).setText(this.f29882o);
        ...
        ViewsKt.m16379l(appCompatImageView, this.f29891x);
        ...
        ViewsKt.m16379l(appCompatImageView2, this.f29892y);
        ...
        textView.setText(time.m16361g(context, this.f29886s));
        AppCompatImageView appCompatImageView3 = (AppCompatImageView) C2052a.m12264B(view2, C2507R.string.profile_comments_to_release, (TextView) view2.findViewById(C2507R.id.contentType), C2507R.id.edited);
        Intrinsics.m32178g(appCompatImageView3, "view.edited");
        ViewsKt.m16379l(appCompatImageView3, this.f29887t);
        TextView textView2 = (TextView) view2.findViewById(C2507R.id.message);
        Intrinsics.m32178g(textView2, "view.message");
        ViewsKt.m16373f(textView2, this.f29888u, false, null, 6);
        TextView textView3 = (TextView) view2.findViewById(C2507R.id.deleted);
        Intrinsics.m32178g(textView3, "view.deleted");
        ViewsKt.m16379l(textView3, this.f29888u);
        if (!this.f29888u) {
            if (this.f29884q || this.f29885r <= -5) {
        ...
        ((TextView) view2.findViewById(C2507R.id.votes)).setText(StringsKt.m33891Q(String.valueOf(this.f29885r), "-", "–", false, 4, null));
        int i3 = this.f29885r;
        if (i3 == 0) {
        ...
        ViewsKt.m16368a(appCompatImageView4, this.f29890w);
        ViewsKt.m16377j(view2, new Function1<View, Unit>() { // from class: com.swiftsoft.anixartd.ui.model.main.profile.comments.ProfileReleaseCommentModel$bind$9
            {
                super(1);
            }
            ...
            public Unit invoke(View view3) {
                ...
                ProfileReleaseCommentModel profileReleaseCommentModel = ProfileReleaseCommentModel.this;
                ProfileReleaseCommentModel.Listener listener = profileReleaseCommentModel.f29893z;
                if (listener != null) {
                    listener.mo14864N(profileReleaseCommentModel.f29881n, profileReleaseCommentModel.f29879l, profileReleaseCommentModel.f29880m);
                    return Unit.f63088a;
                }
        ...
        ViewsKt.m16377j(appCompatImageView5, new Function1<View, Unit>() { // from class: com.swiftsoft.anixartd.ui.model.main.profile.comments.ProfileReleaseCommentModel$bind$10
            {
                super(1);
            }
            ...
            public Unit invoke(View view3) {
                ...
                ProfileReleaseCommentModel.Listener listener = profileReleaseCommentModel.f29893z;
                if (listener != null) {
                    listener.mo14866f(profileReleaseCommentModel.f29878k);
                    return Unit.f63088a;
                }
                Intrinsics.m32189r("listener");
                throw null;
    ...
    public void mo4497a2(View view, EpoxyModel epoxyModel) {
        ...
        if (epoxyModel instanceof ProfileReleaseCommentModel) {
            ProfileReleaseCommentModel profileReleaseCommentModel = (ProfileReleaseCommentModel) epoxyModel;
            if (!Intrinsics.m32174c(this.f29883p, profileReleaseCommentModel.f29883p)) {
                m12276k.add(0);
            }
            if (this.f29884q != profileReleaseCommentModel.f29884q) {
                m12276k.add(1);
            }
            if (this.f29885r != profileReleaseCommentModel.f29885r) {
                m12276k.add(2);
            }
            if (this.f29886s != profileReleaseCommentModel.f29886s) {
                m12276k.add(3);
            }
            if (this.f29887t != profileReleaseCommentModel.f29887t) {
                m12276k.add(9);
            }
            if (this.f29888u != profileReleaseCommentModel.f29888u) {
                m12276k.add(10);
            }
            if (!Intrinsics.m32174c(this.f29889v, profileReleaseCommentModel.f29889v)) {
                m12276k.add(4);
            }
            if (!Intrinsics.m32174c(this.f29890w, profileReleaseCommentModel.f29890w)) {
                m12276k.add(5);
            }
            if (this.f29891x != profileReleaseCommentModel.f29891x) {
                m12276k.add(6);
            }
            if (this.f29892y != profileReleaseCommentModel.f29892y) {
                m12276k.add(7);
            }
            if (!Intrinsics.m32174c(this.f29882o, profileReleaseCommentModel.f29882o)) {
                m12276k.add(8);
            }
            if (!m12276k.isEmpty()) {
    ...
    public void mo4519b2(@NotNull View view, @NotNull List<Object> list) {
        if (C2052a.m12291z(view, "view", list, "payloads", 0)) {
            ((TextView) view.findViewById(C2507R.id.message)).setText(this.f29883p);
        }
        int i2 = 3;
        if (list.contains(1)) {
            if (this.f29884q || this.f29885r <= -5) {
        ...
        if (list.contains(2)) {
            ((TextView) view.findViewById(C2507R.id.votes)).setText(StringsKt.m33891Q(String.valueOf(this.f29885r), "-", "–", false, 4, null));
            int i4 = this.f29885r;
            if (i4 == 0) {
        ...
        if (list.contains(3)) {
            ...
            Intrinsics.m32178g(context, "view.context");
            textView4.setText(time.m16361g(context, this.f29886s));
        }
        if (list.contains(9)) {
        ...
        if (list.contains(5)) {
            ...
            ViewsKt.m16375h(appCompatImageView2, this.f29890w);
        }
        if (list.contains(6)) {
            ...
            ViewsKt.m16379l(appCompatImageView3, this.f29891x);
        }
        if (list.contains(7)) {
            ...
            ViewsKt.m16379l(appCompatImageView4, this.f29892y);
        }
        if (list.contains(8)) {
            ((TextView) view.findViewById(C2507R.id.title)).setText(this.f29882o);
        }
    }
