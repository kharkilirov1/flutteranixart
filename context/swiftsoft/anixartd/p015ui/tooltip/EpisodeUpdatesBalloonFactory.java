...
@Metadata(m31882bv = {}, m31883d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/tooltip/EpisodeUpdatesBalloonFactory;", "Lcom/skydoves/balloon/Balloon$Factory;", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
...
public final class EpisodeUpdatesBalloonFactory extends Balloon.Factory {
    ...
    public Balloon mo13871a(@NotNull Context context, @Nullable LifecycleOwner lifecycleOwner) {
        ...
        builder.f24686l = 0.9f;
        builder.m13868k(8);
        builder.m13867j(8);
        builder.m13866i(8);
        builder.m13864g(12.0f);
        builder.m13865h(2);
        builder.m13870m(C2507R.string.tooltip_episode_updates);
