...
@Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b&\u0018\u00002\u00020\u00012\u00020\u0002B\u0007¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m31884d2 = {"Lcom/swiftsoft/anixartd/ui/fragment/main/TabFragment;", "Lcom/swiftsoft/anixartd/ui/fragment/BaseFragment;", "Lcom/swiftsoft/anixartd/ui/Refreshable;", "<init>", "()V", "app_release"}, m31885k = 1, m31886mv = {1, 7, 1})
/* loaded from: classes2.dex */
public abstract class TabFragment extends BaseFragment implements Refreshable {

    /* renamed from: e */
    public static final /* synthetic */ int f27884e = 0;

    /* renamed from: d */
    @NotNull
    public Map<Integer, View> f27885d = new LinkedHashMap();

    @Nullable
    /* renamed from: A3 */
    public View mo15453A3(int i2) {
        View findViewById;
        Map<Integer, View> map = this.f27885d;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        View inflate = inflater.inflate(C2507R.layout.fragment_tab, viewGroup, false);
        ...
        swipeRefreshLayout.setOnRefreshListener(new C0273a(this, 12));
        ...
        ViewsKt.m16377j(materialButton, new Function1<View, Unit>() { // from class: com.swiftsoft.anixartd.ui.fragment.main.TabFragment$onCreateView$2
        ...
        ViewsKt.m16377j(materialButton2, new Function1<View, Unit>() { // from class: com.swiftsoft.anixartd.ui.fragment.main.TabFragment$onCreateView$3
            {
                super(1);
            }
            ...
            public Unit invoke(View view) {
                ...
                ((SwipeRefreshLayout) TabFragment.this.mo15453A3(C2507R.id.refresh)).setEnabled(true);
                LinearLayout error_layout = (LinearLayout) TabFragment.this.mo15453A3(C2507R.id.error_layout);
                Intrinsics.m32178g(error_layout, "error_layout");
                ViewsKt.m16372e(error_layout);
                TabFragment.this.mo15322u();
                return Unit.f63088a;
            }
        });
        return inflate;
